...
namespace AdminTTCS_64130531.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly AdminTTCS_64130531.Models.QLDienThoaiPDH_64130531Entities _db;
     
        public HomeController()
        {
            _db = new AdminTTCS_64130531.Models.QLDienThoaiPDH_64130531Entities();
        }
        ...
        private async Task<Thongke> GetRevenueAsync(Func<AdminTTCS_64130531.Models.QLDienThoaiPDH_64130531Entities, Task<Thongke>> queryFunc)
        {
