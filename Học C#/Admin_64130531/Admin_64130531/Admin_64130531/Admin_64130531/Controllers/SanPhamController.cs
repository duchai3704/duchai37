...
namespace Admin_64130531.Controllers
{
    public class SanPhamController : Controller
    {
        ...
        public ActionResult Edit( Sanpham update)
        {
            ...
            sanpham.maNhan = update.maNhan;
            sanpham.maDanhmuc = update.maDanhmuc;
        ...
        public ActionResult Create(Sanpham model)
        {
            ...
            {
                using (var context = new Admin_64130531.Models.QLBanGiay_64130531Entities())
                {
        ...
        public ActionResult Editsp(string id)
        {
            using (var context = new Admin_64130531.Models.QLBanGiay_64130531Entities())
            {
                ...
                ViewBag.dm = sanpham.Danhmuc;
                ViewBag.nh = sanpham.Nhanhieu;
                @ViewBag.sp = sanpham;
